    ...
    <div class="modal-content">
      <div class="modal-body">
        ...
        <figure>
          ...
          <img class="js-modal-product-cover product-cover-modal" width="{$product.cover.large.width}" src="{$product.cover.large.url|replace:'-thickbox_default':''}" alt="{$product.cover.legend}" title="{$product.cover.legend}" itemprop="image">
