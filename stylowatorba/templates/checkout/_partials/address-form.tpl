...
{block name='form_fields' append}
  ...
  {if $type === "delivery"}
      ...
      <div class="col-md-9 col-md-offset-3">
        <label>
            <input name = "chce_fakture" type = "checkbox" value = "1">
        {l s='Use this address for invoice too' d='Shop.Theme.Checkout'}</label>
      </div>
    </div>
      ...
      <div class="col-md-9 col-md-offset-3">
        <label>
            <input name = "use_same_address" type = "checkbox" value = "1" {if $use_same_address == 1} checked {/if}>
        {l s='Use this address for invoice too' d='Shop.Theme.Checkout'}</label>
      </div>
    </div>
  {/if}
