...
<div id="search_widget" class="col-lg-10 col-md-10 col-sm-12 search-widget" style="padding:0;" data-search-controller-url="{$search_controller_url}">
