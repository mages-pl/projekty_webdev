...
<div class="col-md-8 links">
  <div class="row">
  {foreach $linkBlocks as $kblock => $linkBlock}
    <div class="col-md-6 wrapper">
      ...
      {if $kblock == 0}
          <h3 class="h3 hidden-sm-down">Dane firmy</h3>
          MAGES Michał Jendraszczyk
<div class="block-firma">

<p>
<i class="material-icons">place</i>    
    Cyfrowa 6, 71-441 Szczecin</p>

<p>
    <i class="material-icons">mail_outline</i>
    bok@stylowatorba.pl</p>

<p>
    <i class="material-icons">phone</i>
    794 746 622</p>
    
<p> <strong>NIP</strong> 853 151 50 66 </p>
    </div>
          {/if}
          </div>
  {/foreach}
