...
<div id="productCommentsBlock">
    <h1 class="h1 products-section-title text-uppercase ">{l s='Opinie klientów' mod='productcomments'}</h1>
    <div class="tabs">
        ...
        <div id="product_comments_block_tab">
                    ...
                    {if $comment.content}
                        <div class="comment clearfix">
                            <div class="comment_author">
                                {*<span>{l s='Ocena' mod='productcomments'}&nbsp</span>*}
                                ...
                                <div class="comment_author_infos">
                                  {*  <strong>Klient {*{$comment.customer_name|escape:'html':'UTF-8'}</strong><br/>
            ...
            {else}
                {if (!$too_early AND ($logged OR $allow_guests))}
                    <p class="align_center alert info">
